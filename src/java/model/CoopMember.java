...
@NamedQueries({
    ...
    @NamedQuery(name = "CoopMember.findBySss", query = "SELECT c FROM CoopMember c WHERE c.sss = :sss"),
    ...
    @NamedQuery(name = "CoopMember.findByGsis", query = "SELECT c FROM CoopMember c WHERE c.gsis = :gsis")})
public class CoopMember implements Serializable {
    ...
    @OneToMany(mappedBy = "regMemNo")
    private Collection<CoopAssociate> coopAssociateCollection;
    ...
    public CoopMember(String memNo, String memIdNo, String lastName, String firstName, Date birthdate, String residenceType, String street, String barangay, String cityMun, String civilStatus, Date memDate, Date statusDate, boolean nationality) {
        this.memNo = memNo;
    ...
    @XmlTransient
    public Collection<CoopAssociate> getCoopAssociateCollection() {
        return coopAssociateCollection;
    }

    public void setCoopAssociateCollection(Collection<CoopAssociate> coopAssociateCollection) {
        this.coopAssociateCollection = coopAssociateCollection;
    }
